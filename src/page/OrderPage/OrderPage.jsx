...
import { increaseAmount, decreaseAmount, removeOrderProduct, removeAllOrderProduct, selectedOrder } from '../../app/slide/orderSlide'
  ...
  return (
    <div style={{ background: '#f5f5fa', with: '100%', height: '100vh' }}>
      <div style={{ height: '100%', width: '1100px', margin: '0 auto' }}>
        <h3 style={{ fontWeight: 'bold', margin: '0', padding: '20px 0' }}>Giỏ hàng</h3>
